...
public class WheelView extends View {
    ...
    int itemsVisible = 7;//YXDAG 修改实际可见数
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        Log.e("YXDTAG", "WheelView: density--->" + density);
        ...
        Log.e("YXDTAG", "WheelView: centerContentOffset--->" + centerContentOffset);
        if (attrs != null) {
...
//            float ratio  = lineConfig.getRatio();
        ...
        if (onlyShowCenterLabel && !TextUtils.isEmpty(label)) {
            ...
            Log.e("YXDTAG", "onDraw: drawRightContentStart--->" + drawRightContentStart);
            //手动设置内容与label时间的距离方式 修改数字20 如果要修改label字体大小和内容不一样 需要另外家一个paint
            canvas.drawText(label, drawRightContentStart - centerContentOffset, centerY, paintCenterText);
//            canvas.drawText(label, drawRightContentStart - centerContentOffset - 20, centerY, paintCenterText);
